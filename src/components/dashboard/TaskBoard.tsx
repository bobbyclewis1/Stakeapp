...
const defaultTasks: Task[] = [
  ...
  },
  {
    ...
    description: "Optimize rendering performance on dashboard",
    status: "in-progress",
    assignee: {
      name: "Frank Thomas",
  ...
  },
  {
    ...
    description: "Create improved onboarding experience for new users",
    status: "done",
    assignee: {
      name: "Henry Wilson",
  ...
  },
  {
    ...
    description: "Complete the analytics dashboard with charts",
    status: "done",
    assignee: {
      name: "Irene Davis",
